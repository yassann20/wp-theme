...
<main>
        <div id="Blog-content">
            <div class="film">
                <h2>NEWS</h2>
                <p>店舗情報や季節限定のメニュー新作メニューなどのご紹介をしています。
            ...
            ?>
                <dl>
                    ...
                    <?php if (has_post_thumbnail()) : ?>
                      <div class="Arcive-img" style="background-image: url('<?php echo get_the_post_thumbnail_url(); ?>');">
                      </div>
                <?php else : ?>
                    <div class="Arcive-img" style="background-image: url('<?php echo get_template_directory_uri(); ?>/photo/pc-img/coffee2-noimg.jpg')">
                        </div>
                <?php endif; ?>
                        <div class="Arcive-text">
                            <div id="Data">
